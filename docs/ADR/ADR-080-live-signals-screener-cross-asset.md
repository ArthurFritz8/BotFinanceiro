...
2. **Banner PRO Unlock** com countdown persistido em `localStorage`. Stub: NAO consome crédito real — extension point comentado no código para integrar com o sistema de créditos posteriormente.
...
- [x] Commit `feat(web): live signals screener cross-asset (Top Opportunities) - Refs ADR-080` + push.
